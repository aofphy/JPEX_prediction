...
\title{Foundation Models Match Supervised Forecasters on the Japan Electric Power Exchange: A Probabilistic 48-Step Benchmark Across Day-Ahead and Imbalance Markets}

\author[sut]{Panithan Sriboriboon}
\author[sut]{Ittipon Fongkaew\corref{cor}}
\ead{ittipon@sut.ac.th}
\cortext[cor]{Corresponding author. Author ORCID identifiers will be supplied with the production version of the manuscript.}
...
This study uses only publicly available aggregate market-clearing prices and reference series published by the Japan Electric Power Exchange (JEPX) and the Organization for Cross-regional Coordination of Transmission Operators (OCCTO). It involves no human subjects, no animal subjects, and no personally identifiable information; no ethics-committee approval was therefore required. The processed dataset and the derived prediction matrices are released under an open-data licence (CC-BY-4.0) consistent with the public nature of the underlying market data.

\section*{Funding}
This work was supported by institutional research funds of the School of Physics, Institute of Science, Suranaree University of Technology. The authors received no specific external grant from any funding agency in the public, commercial, or not-for-profit sectors. Any specific grant numbers will be appended in the final production version.
